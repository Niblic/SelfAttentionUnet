...
def Attention_ResUNet_SelfAttention(input_shape=( 512 , 512 , 9  )):
    ...
    sa7 = SelfAttentionBlock()(u7)
    # Upsample after self-attention
    #up_sa7 = layers.UpSampling2D((2, 2))(sa7)
    c7 = conv_block(layers.concatenate([sa7, c5]), NUM_FILTER * 16)
    ...
    se10 = squeeze_and_excitation_block(u10)
    c10 = conv_block(layers.concatenate([se10, c2]), NUM_FILTER * 2)

    u11 = upsample_block(c10, NUM_FILTER)
    se11 = squeeze_and_excitation_block(u11)
    c11 = conv_block(layers.concatenate([se11, c1]), NUM_FILTER)
    # Ausgabeschicht
